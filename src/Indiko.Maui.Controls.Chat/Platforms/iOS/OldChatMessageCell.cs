...
//{
//    public class OldChatMessageCell : UICollectionViewCell
//    {
//        public static readonly NSString CellId = new NSString("OldChatMessageCell");
...
//        public OldChatMessageCell(ObjCRuntime.NativeHandle handle) : base(handle)
//        {
//            Initialize();
//        }
...
//            var newTargetSize = size;
//            newTargetSize.Height = nfloat.MaxValue;
...
//            var fittingSize = base.SystemLayoutSizeFittingSize(newTargetSize);
...
//            _avatarView.WidthAnchor.ConstraintEqualTo(48).Active = true;
//            _avatarView.HeightAnchor.ConstraintEqualTo(48).Active = true;
...
//            _imageView.BottomAnchor.ConstraintEqualTo(_frameView.BottomAnchor, -16).Active = true;
...
//            _videoContainer.BottomAnchor.ConstraintEqualTo(_frameView.BottomAnchor, -16).Active = true;

//            // TimestampLabel constraints
//            _timestampLabel.TrailingAnchor.ConstraintEqualTo(_frameView.TrailingAnchor, -8).Active = true;
//            _timestampLabel.BottomAnchor.ConstraintEqualTo(_frameView.BottomAnchor, -8).Active = true;

//            // DeliveryStatusIcon constraints
//            _deliveryStatusIcon.TrailingAnchor.ConstraintEqualTo(_timestampLabel.LeadingAnchor, -8).Active = true;
...
//            _replyContainer.TrailingAnchor.ConstraintEqualTo(_frameView.TrailingAnchor, -16).Active = true;
...
//            _reactionContainer.HeightAnchor.ConstraintGreaterThanOrEqualTo(20).Active = true;
//        }
...
//            {
//                _avatarView.Image = CreateInitialsImage(message.SenderInitials, 28, 28);
//            }
//            else
//            {
...
//            _frameView.WidthAnchor.ConstraintLessThanOrEqualTo(maxWidth).Active = true;
