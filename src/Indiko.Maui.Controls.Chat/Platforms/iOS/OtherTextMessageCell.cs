...
internal class OtherTextMessageCell : BaseTextMessageCell
{
    ...
    {
        return _chatView.OtherMessageBackgroundColor.ToPlatform();
    }

    protected override UIColor GetMessageTextColor()
    {
        return _chatView.OtherMessageTextColor.ToPlatform();
    }
}
