...
public class OtherMessageCell : UICollectionViewCell
{
    ...
    private void UpdateReactions(List<ChatMessageReaction> reactions, ChatView chatView)
    {
        // Entferne alle vorhandenen Reaktionen
        foreach (var view in _reactionsStackView.ArrangedSubviews)
        {
        ...
        foreach (var reaction in reactions)
        {
            ...
            _reactionsStackView.AddArrangedSubview(reactionLabel);
        }

        _reactionsStackView.Hidden = reactions.Count == 0; // Verstecke, falls keine Reaktionen vorhanden sind
    }
}