...
public class OldChatMessageAdapter : RecyclerView.Adapter
{
    ...
    public OldChatMessageAdapter(Context context, IMauiContext mauiContext, ChatView virtualView)
    {
        _context = context;
    ...
    public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        return new OldChatMessageViewHolder(constraintLayout, dateTextView, textView, imageView, videoContainer, videoView, timestampTextView, frameLayout,
    ...
    {
        if (holder is OldChatMessageViewHolder chatHolder)
        {
