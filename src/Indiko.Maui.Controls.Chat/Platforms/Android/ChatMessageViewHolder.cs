...
public class ChatMessageViewHolder : RecyclerView.ViewHolder
{
    ...
    public LinearLayout ReactionContainer { get; } // New container for reactions
    ...
    public ChatMessageViewHolder(aViews.View itemView, TextView dateTextView, TextView textView, ImageView imageView, FrameLayout videoContainer, 
        VideoView videoView, TextView timestampTextView, FrameLayout frameLayout, TextView newMessagesSeparatorTextView, ImageView avatarView, LinearLayout reactionContainer)
        : base(itemView)
    {
